...
//			}
//		}
		document.append("tx_pckt_lost",customObj.getTx_pckt_lost());
		document.append("rx_pckt_lost",customObj.getRx_pckt_lost());
		document.append("portCount",customObj.getPortCount());
		document.append("tx_total_pckts",customObj.getTx_total_pckts());
		document.append("rx_total_pckts",customObj.getRx_total_pckts());
		document.append( "avrg_rx_pckt_dropped",customObj.getAvrg_rx_pckt_dropped());
		document.append(" avrg_tx_pckt_dropped",customObj.getAvrg_tx_pckt_dropped());
		//document.append(" lastTimeStamp",customObj.getAvrg_tx_pckt_dropped());
		...
		document.append("lastTimeStamp", new Date().getTime());
